...
import 'package:humic_payroll_mobile_app/app/modules/realization_detail_screen/controllers/realization_detail_screen_controller.dart';
...
class PlanningAddNextScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final realizationController = Get.put(RealizationDetailScreenController());

    int totalBruto = 0;
    int totalTax = 0;
    int totalNetto = 0;

    if (realizationController.realizationDetailData?.data?.item != null) {
      for (var data
          in realizationController.realizationDetailData!.data!.item!) {
