...
import 'package:humic_payroll_mobile_app/app/utils/constants/image_extence_checker.dart';
...
class RealizationEditItemScreenView
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<RealizationEditItemScreenController>(builder: (_) {
      return Scaffold(
