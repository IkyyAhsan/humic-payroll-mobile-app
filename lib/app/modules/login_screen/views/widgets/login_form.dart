      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: (value) => HumicValidators.loginEmailValidate(value),
            decoration: InputDecoration(
                ...
                focusedBorder: const OutlineInputBorder(
                    borderSide: BorderSide(color: HumiColors.humicBlackColor))),
          ),
          verticalSpace(16),
          ...
          Obx(
            () => TextFormField(
              ...
              validator: (value) =>
                  HumicValidators.loginPasswordValidate(value),
