                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            onTap: () async {
                              final int? pickedYear =
                                ...
                                builder: (BuildContext context) {
                                  int tempYear =
                                      controller.selectedRealizationYear.value;
                                  return Container(
                                ...
                                () => DropdownButtonHideUnderline(
                                  child: DropdownButton<int>(
                                    ...
                                    onChanged: (int? newValue) {
                                      if (newValue != null &&
                                          newValue !=
                                              controller.selectedRealizationYear
                                                  .value) {
                                        controller
                        ...
                        if (controller
                                .realizationData.value.data?.data?.isEmpty ??
                            true)
                          Center(
                            child: Column(
                              children: [
                        ...
                        ListView.builder(
                          itemCount: controller
                              .realizationData.value.data?.data?.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            final data = controller
                                .realizationData.value.data?.data?[index];
