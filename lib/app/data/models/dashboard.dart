...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        monthlyIncomeExpenseData: json["monthlyIncomeExpenseData"] == null ? [] : List<MonthlyIncomeExpenseDatum>.from(json["monthlyIncomeExpenseData"]!.map((x) => MonthlyIncomeExpenseDatum.fromJson(x))),
        approval: json["approval"] == null ? null : Approval.fromJson(json["approval"]),
        pieChart: json["pieChart"] == null ? null : PieChart.fromJson(json["pieChart"]),
        transactionList: json["transactionList"] == null ? null : TransactionList.fromJson(json["transactionList"]),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "monthlyIncomeExpenseData": monthlyIncomeExpenseData == null ? [] : List<dynamic>.from(monthlyIncomeExpenseData!.map((x) => x.toJson())),
...
class MonthlyIncomeExpenseDatum {
    ...
    factory MonthlyIncomeExpenseDatum.fromJson(Map<String, dynamic> json) => MonthlyIncomeExpenseDatum(
        name: json["name"],
        income: json["income"],
...
class PieChart {
    ...
    factory PieChart.fromJson(Map<String, dynamic> json) => PieChart(
        ...
        planningData: json["planningData"] == null ? [] : List<Datum>.from(json["planningData"]!.map((x) => Datum.fromJson(x))),
        totalRealization: json["totalRealization"],
        realizationData: json["realizationData"] == null ? [] : List<Datum>.from(json["realizationData"]!.map((x) => Datum.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "totalPlanning": totalPlanning,
        "planningData": planningData == null ? [] : List<dynamic>.from(planningData!.map((x) => x.toJson())),
        "totalRealization": totalRealization,
        "realizationData": realizationData == null ? [] : List<dynamic>.from(realizationData!.map((x) => x.toJson())),
    };
}
